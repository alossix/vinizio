  ...
  return (
    <div className="liguria-page">
      ...
      <p>
        ...
        regions with the most notable being the Cinque Terre DOC from
        cliff side vineyards situated among the five fishing villages
        of Cinque Terre in the province of La Spezia. The DOC produces
        light white wines made from grape varieties such as Bosco,
        Albarola and Vermentino. In the west is the red wine-producing
        region of Dolceacqua, producing wine from the indigenous
        Rossese grape.[2]
      </p>
    </div>
  );
